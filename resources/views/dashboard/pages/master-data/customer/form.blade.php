        ...
        <div class="card-body pt-0">
            <form action="{{ $action_url }}" method="POST" class="row">
                ...
                <div class="col-12 mb-3">
                    <label for="name" class="form-label required">Nama Pelanggan</label>
                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name', $data?->name) }}" placeholder="Masukkan Nama Pelanggan" required>
                    @error('name')
                ...
                <div class="col-12 mb-3">
                    ...
                    <textarea name="address" id="address" rows="4" class="form-control" placeholder="Masukkan Alamat Pelanggan" required>{{ old('address', $data?->address) }}</textarea>
                    @error('address')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
