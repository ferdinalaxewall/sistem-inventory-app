                        ...
                        <table align="center" role="presentation" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                    ...
                                    <table class="card p-6 p-lg-10 space-y-4" role="presentation" border="0"
                                        ...
                                        <tr>
                                            <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;"
                                                ...
                                                <p class=""
                                                   style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;"
                                                   align="left">
                                                    Terimakasih sudah mendaftar di <strong>{{ config('app.name') }}</strong>. Berikut kode
                                                    verifikasi akun anda :
                                                </p>
                                                <table class="s-4 w-full" role="presentation" border="0" cellpadding="0"
                                                       cellspacing="0" style="width: 100%; margin: 2rem 0;"
                                                       width="100%">
                                                    <tbody>
                                                    <tr>
                                                        <td style="line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;"
                                                            align="center" width="100%" height="16">
                                                            <div
                                                                style="background-color: #EDEBEEFF; border: 1px solid #939393; border-style: dashed; padding: 1rem">
                                                                <h1 style="line-height: 3rem; width: 100%; margin: 0 auto;"
                                                                    align="center">{{ $verifyCode }}</h1>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                ...
                                                <table class="btn btn-primary p-3 fw-700" role="presentation" border="0"
                                                       cellpadding="0" cellspacing="0"
                                                       style="border-radius: 6px; border-collapse: separate !important; font-weight: 700 !important; width: 100%">
                                                    <tbody>
                                                    <tr>
                                                        ...
                                                        <td  style="line-height: 24px; font-size: 16px; border-radius: 6px; font-weight: 700 !important; margin: 0;"
                                                            ...
                                                            <a href="{{ route('auth.verify-account', $user_id) }}"
                                                               style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: 700 !important; white-space: nowrap; background-color: #696cff; padding: 12px; border: 1px solid #696cff;">Kunjungi Website</a>
                                                        </td>
                                                        <td style="width: 30%"></td>
                                                    </tr>
                                                    </tbody>
                                    ...
                                    <table class="s-4" style="width: 100%; margin-top: 2rem;">
                                        <tr align="center">
                                            <td style="text-align: center">&copy; {{ config('app.name') }} - {{ now()->year }}</td>
                                        </tr>
                                    </table>
                                    <table class="s-10 w-full" role="presentation" border="0" cellpadding="0"
                                           cellspacing="0" style="width: 100%;" width="100%">
